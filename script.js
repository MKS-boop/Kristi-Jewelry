...
(function(){
  ...
  function ensureHeroControl(frame, cls, label, href){
    ...
    if(!el){el=document.createElement(href?'a':'button');el.className='kristi-hero-control '+cls;if(href) el.href=href;else el.type='button';el.setAttribute('aria-label',label);frame.appendChild(el);}
    return el;
  }
